...
const DEMO_KEY = "demo-public-siteenrich";
  ...
  async function handleAnalyze() {
    ...
    try {
      const res = await fetch(
        `https://api.siteenrich.io/analyze?url=${encodeURIComponent(
          url.trim()
        )}`,
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-[#666] text-sm max-w-xl mx-auto leading-relaxed">
            Paste a URL from a scraped lead list and see how SiteEnrich cleans,
            classifies, and routes it before enrichment or outreach.
          </p>
        </div>
        ...
        <div className="flex gap-3 mb-8">
          <div className="flex-1 relative">
            <input
              ...
              onKeyDown={handleKey}
              placeholder="e.g. examplecontractor.com/%3Futm_source%3Dgoogle"
          ...
          <button
            ...
            style={{
              boxShadow: status !== "loading" ? "0 0 20px #00ff8833" : "none",
            }}
          >
            {status === "loading" ? (
        ...
        {status === "done" && (
          <div className="mt-8 text-center">
            <p className="text-[#666] text-sm mb-4">
              Want to test a real scraped list?
            </p>
